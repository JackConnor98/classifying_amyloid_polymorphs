...
required_packages <- c("dplyr", "stringr", "tidyr", "readr", "ggplot2", "bio3d", "purrr")
...
data <- read_delim(file.path("Output", "selected_pdbs_metadata.txt"), 
...
# Saving
#write.csv(residues, file = "Output/ordered_residues.csv", row.names = FALSE)
...
# Saving Plot
ggsave(plot = last_plot(), file = file.path("Output", "Ordered_Residues.png"), height = 8, width = 20)
